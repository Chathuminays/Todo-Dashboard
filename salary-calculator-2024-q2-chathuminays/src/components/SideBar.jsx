...
const SideBar = () => {
  ...
  return (
    <>
        <div className={`md:w-64 xl:w-56 2xl:w-64 z-30 bg-purple fixed h-full xs:mt-0 lg:mt-0 transition-transform duration-300 ${isOpen ? 'transform-none' : '-translate-x-full'} lg:translate-x-0`}>
            ...
            <div className='flex items-center xl:w-52 2xl:w-60 h-10 py-3 px-3 mx-auto mt-10 gap-5 bg-purple_light rounded-full'>
